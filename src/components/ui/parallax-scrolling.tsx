...
export const ParallaxComponent: React.FC<ParallaxComponentProps> = ({
  ...
  const containerHeight = standalone
    ? 'h-screen'
    : 'min-h-[580px] sm:min-h-[640px] h-[78vh] sm:h-[82vh]';

  return (
    <div className={`relative w-full ${containerHeight} bg-[#030304] select-none text-white overflow-hidden ${className}`}>
      ...
      {/* Layer 2: Orbital Trajectory Concentric Rings */}
      <div className={`absolute ${standalone ? 'top-[54%] sm:top-[56%]' : 'top-[50%] sm:top-[52%]'} left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none flex items-center justify-center z-[2]`}>
      ...
      {/* Layer 3: Horizon Arc & Earth Curvature */}
      <div className="absolute inset-0 pointer-events-none z-[10] flex items-center justify-center overflow-hidden">
        {/* Atmospheric rim subtle radial glow */}
        <div className={`absolute ${standalone ? 'top-[58%] sm:top-[60%] md:top-[62%]' : 'top-[54%] sm:top-[56%] md:top-[58%]'} left-1/2 -translate-x-1/2 w-full sm:w-4/5 h-28 bg-[radial-gradient(ellipse_at_bottom,rgba(255,255,255,0.05)_0%,transparent_65%)] pointer-events-none`} />
        
        {/* Earth curvature crest */}
        <div
          id="earth"
          className={`absolute ${standalone ? 'top-[62%] sm:top-[64%] md:top-[66%]' : 'top-[58%] sm:top-[60%] md:top-[62%]'} left-1/2 -translate-x-1/2 w-[220%] sm:w-[180%] md:w-[150%] h-[120%] rounded-[100%] bg-gradient-to-b from-[#0c0c10] via-[#060608] to-[#020203] border-t border-white/[0.08] shadow-[0_-15px_50px_rgba(255,255,255,0.02)]`}
        />
      </div>

      {/* Layer 4: Central Unified Content */}
      <div className={`absolute ${standalone ? 'top-[52%] sm:top-[54%] md:top-[56%]' : 'top-[46%] sm:top-[48%] md:top-[50%]'} left-1/2 -translate-x-1/2 -translate-y-1/2 z-[30] flex flex-col items-center justify-center text-center px-4 w-full max-w-5xl mx-auto`}>
